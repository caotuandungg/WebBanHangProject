...
<nav class="navbar navbar-expand-xl navbar-light bg-light">
    <a href="./Home.php" class="navbar-brand"><i class="fa fa-cube"></i>KING<b> FOOD</b></a>
    ...
    <div id="navbarCollapse" class="collapse navbar-collapse justify-content-start">
        ...
        <div class="navbar-nav ml-auto">
            ...
            <div class="nav-item dropdown" style="margin-right: 50px;">
                ...
                <div class="dropdown-menu" >
                    <a href="./edit.php?id=<?php echo $_SESSION['user'][0] ?>" class="dropdown-item"><i class="fa fa-user-o"></i> Trang cá nhân</a></a>
...
<section class="jumbotron text-center">
            <div class="container">
                <h1 class="text black" class="jumbotron-heading">KING FOOD</h1>
                <p class="lead text-muted mb-0">Thực phẩm nhập khẩu sạch và an toàn</p>
            </div>
</section> 
</body>                           